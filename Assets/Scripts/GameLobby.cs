...
public class GameLobby : MonoBehaviour
{
    ...
    void Start()
    {
        //Automatically join Lobby after we connect to Photon Region
            //PhotonNetwork.JoinLobby = true; -> gone in PUN2
        //Enable Lobby Stats to receive the list of Created rooms
            //PhotonNetwork.EnableLobbyStatistics = true; -> done in PhotonServerSettings
    ...
    // Don't know how to do this using PUN2 ..
    ...
    void OnCreatedRoom()
    {
        ...
        //Set our player name
        PhotonNetwork.NickName = playerName;
        //Load the Scene called MainScene (Make sure it's added to build settings)
