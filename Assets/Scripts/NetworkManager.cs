using System.Collections.Generic; using ExitGames.Client.Photon; using UnityEngine;
using Photon.Pun;
    ...
    public class NetworkManager : MonoBehaviour, IConnectionCallbacks, IMatchmakingCallbacks, IOnEventCallback
    {
        ...
        void IMatchmakingCallbacks.OnJoinedRoom() {
            ...
            if (PhotonNetwork.AllocateViewID(photonView))
            {
                ...
                {
                    CachingOption = EventCaching.AddToRoomCache, Receivers = ReceiverGroup.Others
                };
